...
public class BoardBean implements TreeNodeResource {
    ...
    public ResourceKey convert2Resource(String id, String adapterKind,
        ...
        metricDataList.add(new MetricData(new MetricKey(true).add(Constant.ATTR_TYPE), timestamp,
        ...
        metricDataList.add(
            new MetricData(new MetricKey(true).add(Constant.ATTR_PART_NUMBER), timestamp, this.partNumber));
        metricDataList.add(
            new MetricData(new MetricKey(true).add(Constant.ATTR_MANUFACTURE), timestamp, this.manufacture));
        ...
        metricDataList.add(new MetricData(new MetricKey(true).add(Constant.ATTR_PRESENTSTATE), timestamp,
            ConvertUtils.convertPresentState(this.presentState)));
        metricDataList.add(new MetricData(new MetricKey(false).add(Constant.ATTR_HEALTHSTATE), timestamp,
